...
- **[docs/WINDOWS_SSH_TUNNEL.md](docs/WINDOWS_SSH_TUNNEL.md)** / **[docs/TROUBLESHOOTING_SPLIT.md](docs/TROUBLESHOOTING_SPLIT.md)** — split VPS→ПК: если в Telegram «Ошибка связи с ПК», `watch_split_tunnel.ps1`, планировщик (`run_watch_tunnel_hidden.vbs` — без мигания консоли).
